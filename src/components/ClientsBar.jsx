...
function ClientsBar({ customClass }) {
  return (
    <div className={`clientsBar w-full flex flex-wrap gap-10 gap-y-6 px-4 items-center justify-evenly md:justify-center md:gap-20 ${customClass}`}>
      <img src={iconToyota} alt="Toyota" className="h-10" />
      <img src={iconRobles} alt="Los Robles" className="h-10" />
      <img src={iconPemex} alt="PEMEX" className="h-10" />
      <img src={iconRecsa} alt="PEMEX" className="h-10" />
    </div>
  );
}
