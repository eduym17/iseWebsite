...
function ContactForm({ customClass }) {
  return (
    <form onSubmit={(e) => e.preventDefault()} className={`w-[80%] flex flex-col items-center gap-3 ${customClass}`}>
      ...
      <textarea name="question" id="question" cols="30" rows="1" placeholder="¡Haz una pregunta!" className="w-full bg-transparent text-ise-white placeholder-ise-white border-b-2 font-Hero text-xs resize-y" />
