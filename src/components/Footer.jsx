      ...
      <div className={`containerContent px-3 md:px-4 items-stretch divide-y-2 divide-gray-400 ${customClass}`}>
        <div className="flex items-center justify-between mb-1 md:mb-4">
          ...
          <div className="flex flex-col-reverse items-end gap-2 md:flex-row md:items-center md:gap-10">
            <div className="router flex gap-2 text-sm">
              <Link
                to="/soluciones"
                className="hover:text-ise-orange"
              >
                Soluciones
              </Link>
              <Link
            ...
            <div className="social flex gap-3">
              <a
                href="https://www.linkedin.com/company/insituenergia"
                target="_blank"
                rel="noreferrer"
              >
                <img
              ...
              <a
                href="https://twitter.com/InSituEnergia"
                target="_blank"
                rel="noreferrer"
              >
                <img
              ...
              <a
                href="https://www.facebook.com/insituenergia"
                target="_blank"
                rel="noreferrer"
              >
                <img
              ...
              <a
                href="https://www.instagram.com/insituenergia/"
                target="_blank"
                rel="noreferrer"
              >
                <img
        ...
        <div className="pt-1 flex flex-col md:flex-row md:justify-between md:items-center">
          ...
          <div className="copyright pt-1 text-sm flex justify-center">
            <p>
              {`© Todos los derechos reservados. In Situ Energía, ${new Date().getFullYear()}.`}
            </p>
          </div>
        </div>
      </div>
