    ...
    <div className="text-ise-gray-30 bg-ise-gray-10 font-Cabin h-screen flex flex-col justify-between selection:bg-ise-orange selection:text-ise-white">
      ...
      <div id="landingPage" className="landingPage bg-ise-gray-10 containerFull">
        <div className="containerContent lg:flex-row lg:items-center lg:justify-center gap-10">
          <img src={notFound} alt="Not Found" className="w-3/4 max-w-xs lg:w-1/3" />
          <div className="w-full md:w-1/2 flex flex-col items-center">
            <Titles title="Página no encontrada" magicWord="Página" customClass="mt-5" />
            ...
            <ButtonLink to="/" customClass="my-8 lg:my-12">
              Volver a Inicio
            </ButtonLink>
          </div>
        </div>
