      ...
      <div className="bg-ise-gray-10 containerFull">
        <div className="containerContent flex flex-col md:py-4 lg:py-6">
          <div className="flex md:flex-row-reverse md:items-center md:justify-center md:gap-8 lg:gap-16">
            <img
              src={electricSolutionsDeskImg}
              alt="sistema fotovoltaico"
              className="hidden w-4/6 max-w-xs md:flex lg:max-w-sm"
            />
            <div className="flex flex-col items-center lg:w-1/2 md:w-1/2">
              <Titles
                title="Generación de energía eléctrica"
                magicWord="eléctrica"
                customClass="mt-5 md:mt-0 md:text-center md:w-3/5 lg:w-3/4"
              />
              <img
                src={electricSolutionsMobImg}
                alt="Energía eléctrica"
                className="md:hidden w-[90%] max-w-sm rounded-lg mt-4 lg:mt-10 lg:h-40 lg:w-fit"
              />
          ...
          <TechnicalScheme
            title="Net Metering"
            magicWord="Metering"
            subtitleFooter="Generación distribuida"
            customClassSubtitle="my-0"
            customClassParag=""
            customClass="mt-4 md:mt-5 lg:mt-12"
          >
          ...
          <TechnicalScheme
            ...
            customClassSubtitle="my-0"
            customClassParag=""
            customClass="mt-4 md:mt-5 lg:mt-6"
          >
          ...
          <TechnicalScheme
            title="Abasto Aislado"
            magicWord="Aislado"
            subtitleFooter=""
            customClassSubtitle="my-0"
            customClassParag=""
            customClass="mt-4 mb-6 md:mt-5 lg:mt-6 lg:mb-10"
          >
      ...
      <div className="bg-ise-gray-20 containerFull">
        <div className="containerContent flex flex-col md:py-4 lg:py-6">
          <div className="flex md:flex-row md:items-center md:justify-center md:gap-8 lg:gap-16">
            <img
              src={thermalSolutionsDeskImg}
              alt="sistema fotovoltaico"
              className="hidden w-4/6 max-w-xs md:mt-6 md:flex lg:mt-8 lg:max-w-sm"
            />
            <div className="flex flex-col items-center lg:w-1/2 md:w-1/2">
              <Titles
                title="Calentamiento solar de fluidos"
                magicWord="Calentamiento"
                customClass="mt-8 md:mt-0 md:text-center md:w-3/5 lg:w-3/4"
              />
              <img
                src={thermalSolutionsMobImg}
                alt="Energía eléctrica"
                className="md:hidden w-[90%] max-w-sm rounded-lg mt-4 lg:mt-10 lg:h-40 lg:w-fit"
              />
              <Paragraph customClass="mt-3 whitespace-pre-line text-justify md:w-full md:mt-4">
          ...
          <TechnicalScheme
            ...
            magicWord="Media"
            subtitleFooter=""
            customClassSubtitle="my-0 md:tracking-tight"
            customClassParag=""
            customClass="mt-4 md:mt-5 lg:mt-6"
          >
          ...
          <div className="flex md:flex-row-reverse md:items-center md:justify-center md:gap-8 lg:gap-16">
            ...
            <div className="flex flex-col items-center lg:w-1/2 md:w-1/2">
              <Titles
                ...
                magicWord="Almacenamiento"
                customClass="mt-8 md:mt-0 md:text-center md:w-2/3 lg:w-4/5"
              />
              <img
                src={storageSolutionsMobImg}
                alt="Energía eléctrica"
                className="md:hidden w-[90%] max-w-sm rounded-lg mt-4 lg:mt-10 lg:h-40 lg:w-fit"
              />
              <Paragraph customClass="mt-3 whitespace-pre-line text-justify md:w-full md:mt-4">
